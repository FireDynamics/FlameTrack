...
test_emissivity_one_is_identity()
print("Done 1")
test_lower_emissivity_increases_corrected_temperature()
print("Done 2")
test_region_mask_rectangle_covers_expected_area()
print("Done 3")
test_region_mask_polygon()
print("Done 4")
test_apply_region_corrections_only_touches_masked_pixels()
print("Done 5")
test_apply_region_corrections_multiple_non_overlapping_regions()
print("Done 6")
test_apply_region_corrections_no_regions_returns_unchanged_copy()
print("Done 7")
test_apply_region_corrections_empty_mask_is_skipped()
print("Done 8")
